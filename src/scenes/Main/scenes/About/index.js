    ...
    <div id="about-container">
      ...
      <div id="about-text">
        ...
        <Typography color="textPrimary" align="justify">
          ...
          SQL-based Tessitura CRM. After a few years of leveraging my broadening Tessitura skills to
          secure successively more technical positions, I realized that coding was what I really
          enjoyed, and decided to pursue it full-force. I attended Fullstack Academy&apos;s remote
          Software Engineering bootcamp, and shortly thereafter began working at
          {' '}
